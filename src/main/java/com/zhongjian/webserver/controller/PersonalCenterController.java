...
public class PersonalCenterController {
	...
	@ApiOperation(httpMethod = "POST", notes = "根据token获取个人中心数据", value = "初始化个人中心数据")
	@RequestMapping(value = "/PersonalCenter/initPersonalCenterData/{token}", method = RequestMethod.POST)
	...
	@ApiOperation(httpMethod = "POST", notes = "根据token获取待付款订单", value = "待付款")
	@RequestMapping(value = "/PersonalCenter/itemsToBePaidFor/{token}", method = RequestMethod.POST)
	Result<Object> itemsToBePaidFor(@PathVariable("token") String token) throws BusinessException {
		return null;
	
	}
	
	@ApiOperation(httpMethod = "POST", notes = "根据token获取购物车信息", value = "我的购物车")
	@RequestMapping(value = "/PersonalCenter/getShoppingCartInfo/{token}", method = RequestMethod.POST)
